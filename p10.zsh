# Generated by Powerlevel10k configuration wizard on 2026-05-01 at 01:00 WIB.
...
() {
  ...
  function prompt_base_py() {
    if [[ -n "$VIRTUAL_ENV" ]]; then
      p10k segment -f 0 -b 39 -t "$(basename $VIRTUAL_ENV) py"
    else
      p10k segment -f 0 -b 39 -t "base py"
    fi
  }
